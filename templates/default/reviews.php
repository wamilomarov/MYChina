<div id="attention">
    <?=$text->attention_1?><br /><?=$text->attention_2?> <span><?=$text->attention_3_span?></span>
    <?=$text->attention_4?><br /><br />
    <a class="btn jsModalTrigger" data-target="jsModalForm_full" data-title="Отправьте заявку сейчас" data-subtitle="Получить контакты" onclick="ga('send', 'event', 'контакты', 'заказать')">
        <?=$text->get_contacts?>
    </a>
</div><br />
<!--================================================
...
<!--<div class="container container_reviews">
    <h2 style="margin-bottom:30px;" class="title reviews__title">Отзывы наших клиентов</h2>
</div>-->
...
<section class="reviews" id="reviews">
    <div class="jsSlider-5 reviews__slider">

        <?php foreach ($reviews as $review){?>
        <div>
            <div class="reviews__slider-item reviews__slider-item--1">
                <div class="container">
                    <img class="lazyload" src="<?= "http://localhost/china2/admin/img/feedback_photo/".$review['photo'];?>" alt="" width="220px" height="220px"/>
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/02.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/03.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/04.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/05.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/06.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/07.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/09.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/11.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/12.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/13.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/14.jpg" alt=""/>-->
...
<!--                <div class="container">-->
<!--                    <img class="lazyload" src="--><?php //echo $config['img'];?><!--reviews/15.jpg" alt=""/>-->
